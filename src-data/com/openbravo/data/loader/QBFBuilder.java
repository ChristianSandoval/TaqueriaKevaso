...
//    }
    public QBFBuilder(String sSentence, String[] asFindFields) {
        ...
        /*
        int iPos2 = m_sSentNullFilter.lastIndexOf("?(QBF_FILTER)");
        if(iPos2>iPos)
        {
        if (iPos < 0) {
            m_sSentBeginPart = sSentence;
            ...
            m_sSentBeginPart = m_sSentNullFilter.substring(0, iPos);
            m_sSentEndPart = m_sSentNullFilter.substring(iPos + 13);
            m_sSentNullFilter = m_sSentBeginPart + "(1=1)" + m_sSentEndPart;
        }*/
