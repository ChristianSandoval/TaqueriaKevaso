...
//    }
    ...
    private void initComponents() {
        ...
        jEditAttributes.setBounds(240, 240, 70, 23);
        ...
        m_jcodebar.setBounds(280, 150, 130, 20);
        ...
        m_jEnter.setBounds(420, 150, 40, 24);
        ...
        m_jreference.setBounds(280, 120, 130, 20);
        ...
        jproduct.setBounds(160, 180, 250, 20);
        ...
        jEditProduct.setBounds(420, 180, 40, 25);
    ...
    private void jEditAttributesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEditAttributesActionPerformed
        if(!m_jprice.getText().equals(""))
        {
           double precio;
            try {
                precio = Double.parseDouble(m_jprice.getText().replace("$", "").replace(",", ""));
                precio=precio*1.16;
                m_jprice.setText(Formats.CURRENCY.formatValue(precio));
