...
public class DataLogicReceipts extends BeanFactoryDataSingle {
    ...
    public final void insertSharedTicket(final String id, final TicketInfo ticket, final String user) throws BasicException {
        
        Object[] values = new Object[] {id, ticket.getName(), ticket, user};
        Datas[] datas = new Datas[] {Datas.STRING, Datas.STRING, Datas.SERIALIZABLE,Datas.STRING};
        
        new PreparedSentence(s
            , "INSERT INTO SHAREDTICKETS (ID, NAME,CONTENT, USER) VALUES (?, ?, ?, ?)"
