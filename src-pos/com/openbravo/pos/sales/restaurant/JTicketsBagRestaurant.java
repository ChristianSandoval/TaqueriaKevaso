...
public class JTicketsBagRestaurant extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(185, 52));
        setPreferredSize(new java.awt.Dimension(245, 72));
        ...
        m_jDelTicket.setMaximumSize(new java.awt.Dimension(54, 42));
        m_jDelTicket.setMinimumSize(new java.awt.Dimension(54, 42));
        m_jDelTicket.setPreferredSize(new java.awt.Dimension(64, 62));
        ...
        jButton2.setMaximumSize(new java.awt.Dimension(54, 42));
        jButton2.setMinimumSize(new java.awt.Dimension(54, 42));
        jButton2.setPreferredSize(new java.awt.Dimension(64, 62));
        ...
        jButton1.setMaximumSize(new java.awt.Dimension(54, 42));
        jButton1.setMinimumSize(new java.awt.Dimension(54, 42));
        jButton1.setPreferredSize(new java.awt.Dimension(64, 62));
