  ...
  private String tipo;
    ...
    public TicketLineInfo(ProductInfoExt product, double dMultiply, double dPrice, TaxInfo tax, Properties attributes) {
        ...
        if (product == null) {
            ...
            pid = product.getID();
            attributes.setProperty("product.code", product.getReference());
...
//         this.impreso = dr.getString(17);
    
  /*  this.tipo = dr.getBoolean(18).toString();
...
public String getProductCode() {
  ...
  public String printImpreso()
  {
    return StringUtils.encodeXML(this.impreso);
  }
  
  public String printTipo()
  {
    return StringUtils.encodeXML(this.tipo);
  }
